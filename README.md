UR5 Kinematics, Collision Checking, and Trajectory Validation Project

This project focuses on kinematic analysis, collision checking, and trajectory validation
for a UR5 industrial manipulator using ROS 2 and MoveIt.

The workflow combines offline kinematics and trajectory generation with online collision
checking through MoveIt state validity services to analyze feasible and infeasible robot
motions in joint space and task space.

The project includes:
- Offline IK-based trajectory generation
- Joint-space collision maps (q1 vs q2)
- Collision-aware trajectory validation
- RViz trajectory playback
- CSV-based collision reports
- ROS 2 integration via a custom package (ur5_traj_tools)
...
- URDF file located at assets/ur5_generated.urdf

--------------------------------------------------

Repository structure :

docs/        command notes and usage
figures/     collision maps, plots, rqt_graph
videos/      RViz demonstrations
data/        npz and csv artifacts
src/         offline planning and analysis code
ur5_ws/      ROS 2 workspace containing ur5_traj_tools
...
Count colliding states (0 = collision-free):
...
assets/ur5_generated.urdf
        ↓
offline IK + trajectory planning
        ↓
trajectory_eaik.npz
        ↓
ROS 2 tools (ur5_traj_tools)
        ↓
MoveIt state validity checks
...
This repository is intended as a technical portfolio project demonstrating
robotic manipulation, kinematics, collision reasoning, and ROS 2 integration.
